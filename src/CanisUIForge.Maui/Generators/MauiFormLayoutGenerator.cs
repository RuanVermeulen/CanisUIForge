...
public class MauiFormLayoutGenerator
{
    private readonly IFileWriter _fileWriter;
    private readonly ITemplateEngine _templateEngine;
    private readonly ITemplateLoader _templateLoader;

    public MauiFormLayoutGenerator(IFileWriter fileWriter, ITemplateEngine templateEngine, ITemplateLoader templateLoader)
    {
    ...
    public async Task GenerateAsync(GenerationPlan plan, string mauiProjectPath)
    {
        ...
        string xamlPath = Path.Combine(componentsDir, "FormLayout.xaml");
        string xamlTemplate = _templateLoader.Load("Components/FormLayout");
        ...
        string csPath = Path.Combine(componentsDir, "FormLayout.xaml.cs");
        string csTemplate = _templateLoader.Load("Components/FormLayoutCs");
