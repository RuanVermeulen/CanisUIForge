...
public class MauiSearchBarViewGenerator
{
    private readonly IFileWriter _fileWriter;
    private readonly ITemplateEngine _templateEngine;
    private readonly ITemplateLoader _templateLoader;

    public MauiSearchBarViewGenerator(IFileWriter fileWriter, ITemplateEngine templateEngine, ITemplateLoader templateLoader)
    {
    ...
    public async Task GenerateAsync(GenerationPlan plan, string mauiProjectPath)
    {
        ...
        string xamlPath = Path.Combine(componentsDir, "SearchBarView.xaml");
        string xamlTemplate = _templateLoader.Load("Components/SearchBarView");
        ...
        string csPath = Path.Combine(componentsDir, "SearchBarView.xaml.cs");
        string csTemplate = _templateLoader.Load("Components/SearchBarViewCs");
